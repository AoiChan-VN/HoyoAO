...
const StateManager = (() => {
  ...
  const _state = {
    ...
    // Skybox — Home domain
    skybox: {
      // Góc khởi đầu khớp với CSS mặc định ở skybox-cube.css — nhìn
      // vào góc giao 2 mặt thay vì nhìn thẳng tâm 1 mặt (trông phẳng).
      rotationX: -10,
      rotationY: 25,
      isDragging: false,
      inertiaX: 0,
      ...
      imagesTotal: 6,
      ready: false,
      loading: false,     // true CHỈ trong lúc đang fetch — luôn tắt khi attempt kết thúc dù thành/bại
