export class VRStatusDashboard extends HTMLElement {
    constructor() {
        super();
    ...
    _bindDashboardEvents() {
        ...
        navButtons.forEach(btn => {
            const handleNav = (e) => {
                ...
                if (viewer && targetType) {
                    viewer.setAttribute('data-type', targetType);
                    viewer.setAttribute('data-title', targetTitle);
